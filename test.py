...
def test_on_dataset():
    ...
    dataset = CocoDetection(
        img_folder=f"/kaggle/input/datasets/minhluu1205/blur-dataset-paper1/dataset_blur_coco/test/img",
        ann_file=f"/kaggle/input/datasets/minhluu1205/blur-dataset-paper1/dataset_blur_coco/test/instances_test.json",
    ...
    if args.model_config is None or args.show_dir and accelerator.is_main_process:
        coco_dt = COCO(f"/kaggle/input/datasets/minhluu1205/blur-dataset-paper1/dataset_blur_coco/test/instances_test.json")
