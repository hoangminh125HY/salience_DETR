...
def test_on_dataset():
    ...
    dataset = CocoDetection(
        img_folder=f"/kaggle/input/datasets/minhluu0102/data-paper1/dataset_yolo12_coco/test/img",
        ann_file=f"/kaggle/input/datasets/minhluu0102/data-paper1/dataset_yolo12_coco/test/anno/instances_test.json",
    ...
    if args.model_config is None or args.show_dir and accelerator.is_main_process:
        coco_dt = COCO(f"/kaggle/input/datasets/minhluu0102/data-paper1/dataset_yolo12_coco/test/anno/instances_test.json")
