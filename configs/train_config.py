...
train_dataset = CocoDetection(
    img_folder="/kaggle/input/dts-4i-uav/UAV.v4i.coco/train/img",
    ann_file="/kaggle/input/dts-4i-uav/UAV.v4i.coco/train/_annotations.coco.json",
    transforms=presets.detr,
    train=True,
)

test_dataset = CocoDetection(
    img_folder="/kaggle/input/dts-4i-uav/UAV.v4i.coco/valid/img",
    ann_file="/kaggle/input/dts-4i-uav/UAV.v4i.coco/valid/_annotations.coco 11.39.21.json",
    transforms=None,
)
